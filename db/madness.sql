...
/*================================= 建立表空间及对应dba*/
 -- create user
 GRANT USAGE ON *.* TO 'madnessh5160506'@'localhost' IDENTIFIED BY 'madnessh5160506' WITH GRANT OPTION;
 -- create database
 CREATE DATABASE madnessh5160506 CHARACTER SET  utf8  COLLATE utf8_general_ci;
 ...
 GRANT SELECT,INSERT,UPDATE,DELETE,CREATE,DROP,LOCK TABLES ON madnessh5160506.*  TO 'madnessh5160506'@'localhost' IDENTIFIED BY 'madnessh5160506';
